...
INSERT INTO workout_template (id, creator_id, workout_plan_id, name) VALUES 
...
(2, 1, 2, 'Vinopenkki käsipainoilla', 'Kevyt paino'),
(3, 2, 4, 'Kyykky', 'Syvältä ja puhtaasti'),
(4, 3, 4, 'Kyykky', 'Ennätyspainot!'),
(5, 3, 5, 'Reidenojennus', 'Hapotus loppuun');

INSERT INTO exercise_set (id, exercise_id, order_index, reps, weight) VALUES 
(1, 1, 0, 10, 80.0),
(2, 1, 1, 10, 80.0),
(3, 1, 2, 10, 80.0),
(4, 2, 0, 12, 28.0),
