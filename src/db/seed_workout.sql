...
-- Users may create stand-alone exercises, without adding them to an existing workout. 
-- For these inserts the workout_session_id is set to NULL 
...
-- These data items are the actual exercises that users want to add to their workouts
